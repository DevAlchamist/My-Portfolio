            ...
            <div class="p-8 bg-white shadow mt-24">
              ...
              <div class="grid grid-cols-1 md:grid-cols-3">
                ...
                <div class="grid grid-cols-3 text-center order-last md:order-first mt-20 md:mt-0">
                  ...
                  <div>
                    ...
                    <p class="text-gray-400">All Task</p>{" "}
                  </div>{" "}
                  <div>
                    {" "}
                    <p class="font-bold text-gray-700 text-xl">10</p>{" "}
                    <p class="text-gray-400">Daily Avg.</p>{" "}
                  </div>{" "}
                  <div>
                    {" "}
              ...
              <div class="pt-12 border-t flex flex-col justify-center">
                ...
                <p class="text-gray-600 text-center font-light lg:px-16">
                  {/* Chatgpt --v */}
                  {/* Passionate self-taught full-stack developer with 1 year of
                  immersive web development exploration. Fueled by curiosity, I
                  dive deep into cutting-edge technologies. Although a newcomer,
                  my dedication and fresh perspective promise to contribute
                  dynamically. Eager to learn and collaborate, I'm here not as a
                  setback, but as an asset—ready to build something amazing
                  together! */}
                  {/* My --v */}
                  Hello! I'm Shubhanshu Nayak, a skilled Full Stack developer
                  proficient in React.js, Express.js, Node.js, MongoDB etc. I
                  excel in creating clean, responsive designs and am dedicated
                  to delivering seamless user experiences. Let's innovate
